...
from MH_Gibbs import Metropolis_in_Gibbs_sampler
from Hamiltonian_MC import Hamiltonian_MCMC
...
def run_all(cfg):
    ...
    # Initialize W&B
    if wandb_run: wandb.init(project='HW3-'+method, entity='cs532-2022')
    ...
    run_programs(programs, mode=mode, method = method, prog_set='HW3', base_dir=base_dir, daphne_dir=daphne_dir, num_samples=num_samples,
